## -*- mode: R; tab-width: 4 -*-
##
## This file was borrowed and adapted from Rcpp, for using in the package 
## RcppOctave.
...
if(require("RUnit", quietly = TRUE)) {
	...
	if (interactive()) {
		...
		odir <- paste(pkg, ".unit.test.output.dir", sep='')
		if( exists( odir, globalenv() ) ){
			output <- get(odir, globalenv())
		} else {
