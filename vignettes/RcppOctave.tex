...
\bibliography{/tmp/Rpkglib_6ab4a5504aa/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.14.5
[September 19, 2014]\footnote{This vignette was built using \octave
3.8.1}}
...
\begin{verbatim}
## $a
## [1] 0.01925 0.21240 0.30528 0.67518
## 
## $b
##        [,1]   [,2]   [,3]
## [1,] 0.3128 0.4647 0.7072
## [2,] 0.8920 0.5370 0.7973
## 
## $c
## [1] "some text"
\end{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: RcppOctave - error in Octave function `fun\_varargout`:\\\#\#\ \  usage: Expecting 1 or 3 output variables.\\\#\#\ \ \ \  fun\_varargout at line 34, column 7}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: RcppOctave - error in Octave function `eval`:\\\#\#\ \  eval: invalid use of statement list}}\begin{alltt}
\hlstd{.O}\hlopt{$}\hlstd{a}
\end{alltt}
\begin{verbatim}
## [1] 0.09704 0.22970
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: RcppOctave - error in Octave function `error`:\\\#\#\ \  this is an error in Octave}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: this is a warning in Octave}}\end{kframe}
\end{knitrout}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.6536 0.825 0.7455 0.4153 0.0862
##  $ u: num [1:5, 1:5] -0.487 -0.47 -0.445 -0.46 -0.363 ...
##  $ v: num [1:5, 1:5] -0.512 -0.508 -0.461 -0.472 -0.21 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component \"u\": Mean relative difference: 3.208e-16"
## [2] "Component \"v\": Mean relative difference: 4.228e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.14.5 pkgmaker_0.25.7   registry_0.2      Rcpp_0.11.2      
[5] knitr_1.6        

loaded via a namespace (and not attached):
[1] codetools_0.2-9 digest_0.6.4    evaluate_0.5.5  formatR_1.0    
[5] highr_0.3       stringr_0.6.2   tools_3.1.1     xtable_1.7-3   
\end{verbatim}
\end{kframe}
\end{knitrout}
}
