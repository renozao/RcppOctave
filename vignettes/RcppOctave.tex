...
\bibliography{/tmp/Rpkglib_78ba41351114/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.10
[September 27, 2013]\footnote{This vignette was built using \octave
3.6.4}}
...
\begin{verbatim}
## $a
## [1] 0.7734 0.3392 0.1778 0.2452
## 
## $b
##        [,1]   [,2]   [,3]
## [1,] 0.9813 0.9305 0.2297
## [2,] 0.9034 0.5521 0.4791
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.7286 0.9286 0.5623 0.2437 0.0985
##  $ u: num [1:5, 1:5] -0.592 -0.45 -0.428 -0.398 -0.324 ...
##  $ v: num [1:5, 1:5] -0.593 -0.449 -0.41 -0.398 -0.348 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 2.526e-16"
## [2] "Component 3: Mean relative difference: 2.595e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.10 pkgmaker_0.17.4 registry_0.2    Rcpp_0.10.4    
[5] knitr_1.4.1    

loaded via a namespace (and not attached):
[1] codetools_0.2-8 digest_0.6.3    evaluate_0.4.7  formatR_0.9    
[5] highr_0.2.1     stringr_0.6.2   tools_3.0.1     xtable_1.7-1   
\end{verbatim}
\end{kframe}
\end{knitrout}
