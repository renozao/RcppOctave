...
\bibliography{/tmp/Rpkglib_283c1a3a4e45/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.14.2
[May  9, 2014]\footnote{This vignette was built using \octave
3.6.4}}
...
\begin{verbatim}
## $a
## [1] 0.9176 0.5341 0.1338 0.4786
## 
## $b
##        [,1]   [,2]   [,3]
## [1,] 0.7249 0.3322 0.3428
## [2,] 0.7487 0.1552 0.5636
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 3.1355 0.8341 0.4872 0.3564 0.0239
##  $ u: num [1:5, 1:5] -0.591 -0.353 -0.346 -0.552 -0.319 ...
##  $ v: num [1:5, 1:5] -0.351 -0.385 -0.555 -0.403 -0.508 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component \"u\": Mean relative difference: 4.104e-16"
## [2] "Component \"v\": Mean relative difference: 3.238e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.14.2 pkgmaker_0.21.1   registry_0.2      Rcpp_0.11.1      
[5] knitr_1.5        

loaded via a namespace (and not attached):
[1] codetools_0.2-8 digest_0.6.4    evaluate_0.5.5  formatR_0.10   
[5] highr_0.3       stringr_0.6.2   tools_3.1.0     xtable_1.7-3   
\end{verbatim}
\end{kframe}
\end{knitrout}
