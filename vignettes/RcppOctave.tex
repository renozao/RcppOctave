...
\bibliography{/tmp/Rpkglib_1e9369337490/RcppOctave/REFERENCES}
...
[October  1, 2013]\footnote{This vignette was built using \octave
3.6.4}}
...
\begin{verbatim}
## $a
## [1] 0.7787 0.9735 0.2483 0.3138
## 
## $b
##        [,1]   [,2]   [,3]
## [1,] 0.3508 0.2308 0.3194
## [2,] 0.8539 0.0959 0.1664
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 3.0045 0.7387 0.2851 0.1664 0.0905
##  $ u: num [1:5, 1:5] -0.536 -0.475 -0.431 -0.374 -0.402 ...
##  $ v: num [1:5, 1:5] -0.515 -0.327 -0.459 -0.499 -0.409 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 4.069e-16"
## [2] "Component 3: Mean relative difference: 3.102e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
