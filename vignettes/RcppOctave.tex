...
\bibliography{/tmp/Rpkglib_66c86b582626/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.13.6
[February 28, 2014]\footnote{This vignette was built using \octave
3.8.0}}
...
\begin{verbatim}
## $a
## [1] 0.3429 0.1355 0.1037 0.9409
## 
## $b
##        [,1]   [,2]      [,3]
## [1,] 0.5776 0.5187 0.0002385
## [2,] 0.9904 0.1866 0.9064649
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.5634 0.9915 0.7108 0.3483 0.0258
##  $ u: num [1:5, 1:5] -0.475 -0.279 -0.428 -0.431 -0.572 ...
##  $ v: num [1:5, 1:5] -0.535 -0.439 -0.517 -0.415 -0.285 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 2.98e-16"
## [2] "Component 3: Mean relative difference: 2.14e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.13.6 pkgmaker_0.19.2   registry_0.2      Rcpp_0.11.0      
[5] knitr_1.5        
