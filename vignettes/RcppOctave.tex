...
\bibliography{/tmp/Rpkglib_67ca3955ce3d/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.19
[June 23, 2017]\footnote{This vignette was built using \octave
4.2.0}}
...
\end{alltt}
\begin{verbatim}
## [1] 0.4301981 0.7785705 0.9009341 0.1167852
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.28363059 0.61538971 0.41800806 0.02831359
## 
## $b
##           [,1]      [,2]      [,3]
## [1,] 0.5422361 0.4571219 0.8121665
## [2,] 0.4317699 0.7872263 0.1160336
## 
## $c
## [1] "some text"
\end{verbatim}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in .CallOctave("{}fun\_varargout"{}, argout = 2): RcppOctave - error in Octave function `fun\_varargout` (usage: called from\\\#\#\ \ \ \  usage at line 63 column 10\\\#\#\ \ \ \  fun\_varargout at line 34 column 7\\\#\# ):\\\#\#\ \  usage is obsolete and will be removed from a future version of Octave, please use print\_usage instead\\\#\# called from}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .CallOctave("{}fun\_varargout"{}, argout = 2): RcppOctave - error in Octave function `fun\_varargout` (usage: called from\\\#\#\ \ \ \  usage at line 63 column 10\\\#\#\ \ \ \  fun\_varargout at line 34 column 7\\\#\# ):\\\#\#\ \  usage: Expecting 1 or 3 output variables.\\\#\# }}\end{kframe}
\end{knitrout}
...
\begin{verbatim}
## [[1]]
## [1] 0.5613105 0.4031979
## 
## [[2]]
## [1] -0.7296817 -1.9198569
## 
## [[3]]
## [1] 0.8451183 0.3252888 0.8591184
\end{verbatim}
\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in FUN(X[[i]], ...): RcppOctave - error in Octave function `eval`:\\\#\#\ \  eval: invalid use of statement list}}\begin{alltt}
\hlstd{.O}\hlopt{$}\hlstd{a}
\end{alltt}
\begin{verbatim}
## [1] 0.5613105 0.4031979
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .CallOctave("{}error"{}, "{}this is an error in Octave"{}): RcppOctave - error in Octave function `error`:\\\#\#\ \  this is an error in Octave}}\begin{alltt}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in .CallOctave("{}warning"{}, "{}this is a warning in Octave"{}): this is a warning in Octave}}\end{kframe}
\end{knitrout}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.3274 0.7219 0.4895 0.3993 0.0727
##  $ u: num [1:5, 1:5] -0.289 -0.445 -0.572 -0.421 -0.463 ...
##  $ v: num [1:5, 1:5] -0.305 -0.376 -0.245 -0.644 -0.54 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component \"u\": Mean relative difference: 3.84763e-16" 
## [2] "Component \"v\": Mean relative difference: 2.764391e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
locale:
 ...
 [3] LC_TIME=C                  LC_COLLATE=en_ZA.UTF-8    
...
[1] knitr_1.16      RcppOctave_0.19 pkgmaker_0.26.7 registry_0.3   
[5] Rcpp_0.12.11   

loaded via a namespace (and not attached):
 [1] compiler_3.4.0   magrittr_1.5     tools_3.4.0      withr_1.0.2     
 [5] stringi_1.1.5    codetools_0.2-15 highr_0.6        stringr_1.2.0   
 [9] digest_0.6.12    xtable_1.8-2     evaluate_0.10   
\end{verbatim}
\end{kframe}
\end{knitrout}
}
