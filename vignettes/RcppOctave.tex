...
\bibliography{/tmp/Rpkglib_281b7906adcc/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.16
[June  4, 2015]\footnote{This vignette was built using \octave
3.8.1}}
...
\end{alltt}
\begin{verbatim}
## [1] 0.2993035018 0.0007675409 0.2705366798 0.4234020347
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.5762003 0.5768093 0.0617600 0.9912986
## 
## $b
##            [,1]      [,2]      [,3]
## [1,] 0.04883472 0.5336333 0.8338933
## [2,] 0.73256321 0.7748761 0.7519246
## 
## $c
## [1] "some text"
\end{verbatim}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .CallOctave("{}fun\_varargout"{}, argout = 2): RcppOctave - error in Octave function `fun\_varargout`:\\\#\#\ \  usage: Expecting 1 or 3 output variables.\\\#\#\ \ \ \  fun\_varargout at line 34, column 7}}\end{kframe}
\end{knitrout}
...
\begin{verbatim}
## [[1]]
## [1] 0.70466822 0.03875278
## 
## [[2]]
## [1]  0.3319237 -1.3078108
## 
## [[3]]
## [1] 0.7462565 0.3679739 0.1722518
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.6242 0.868 0.6972 0.1767 0.0499
##  $ u: num [1:5, 1:5] -0.354 -0.52 -0.438 -0.374 -0.522 ...
##  $ v: num [1:5, 1:5] -0.27 -0.533 -0.169 -0.566 -0.542 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component \"u\": Mean relative difference: 2.721664e-16"
## [2] "Component \"v\": Mean relative difference: 3.811115e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
FIXES
    ...
    o Added configure option --without-rprofile to disable loading in internal 
...
[1] knitr_1.10.5    RcppOctave_0.16 pkgmaker_0.25.9 registry_0.2   
[5] Rcpp_0.11.6    

loaded via a namespace (and not attached):
 [1] magrittr_1.5     formatR_1.2      tools_3.2.0      stringi_0.4-1   
 [5] codetools_0.2-11 highr_0.5        stringr_1.0.0    digest_0.6.8    
 [9] xtable_1.7-4     evaluate_0.7    
\end{verbatim}
\end{kframe}
\end{knitrout}
}
