...
\bibliography{/tmp/Rpkglib_dac1f300381/RcppOctave/REFERENCES}
...
[March  4, 2014]\footnote{This vignette was built using \octave
3.8.0}}
...
\begin{verbatim}
## $a
## [1] 0.14441 0.83731 0.04326 0.67256
## 
## $b
##        [,1]   [,2]    [,3]
## [1,] 0.7326 0.7040 0.44765
## [2,] 0.0404 0.9996 0.02942
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.439 0.892 0.606 0.347 0.303
##  $ u: num [1:5, 1:5] -0.373 -0.453 -0.475 -0.599 -0.268 ...
##  $ v: num [1:5, 1:5] -0.464 -0.502 -0.276 -0.594 -0.323 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 3.909e-16"
## [2] "Component 3: Mean relative difference: 3.284e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.13.6 pkgmaker_0.19.3   registry_0.2      Rcpp_0.11.0      
[5] knitr_1.5        
