...
\bibliography{/tmp/Rpkglib_64032a9aaaf9/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.11
[October 22, 2013]\footnote{This vignette was built using \octave
3.6.4}}
...
Developments to run on Windows and Mac have recently started, and have been
quite succesful so far.
...
\begin{verbatim}
## $a
## [1] 0.31240 0.04233 0.31967 0.02991
## 
## $b
##        [,1]    [,2]    [,3]
## [1,] 0.9680 0.83901 0.04277
## [2,] 0.5511 0.02082 0.69347
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.4708 0.9751 0.2519 0.1879 0.0818
##  $ u: num [1:5, 1:5] -0.373 -0.482 -0.387 -0.579 -0.378 ...
##  $ v: num [1:5, 1:5] -0.497 -0.441 -0.533 -0.272 -0.448 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 3.506e-16"
## [2] "Component 3: Mean relative difference: 3.051e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.11 pkgmaker_0.17.4 registry_0.2    Rcpp_0.10.5    
[5] knitr_1.5      

loaded via a namespace (and not attached):
[1] codetools_0.2-8 digest_0.6.3    evaluate_0.5.1  formatR_0.9    
[5] highr_0.2.1     stringr_0.6.2   tools_3.0.2     xtable_1.7-1   
\end{verbatim}
\end{kframe}
\end{knitrout}
