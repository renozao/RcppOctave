...
\bibliography{/tmp/Rpkglib_1a5471b39556/RcppOctave/REFERENCES}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.7787 0.6654 0.4976 0.1559 0.0698
##  $ u: num [1:5, 1:5] -0.449 -0.489 -0.326 -0.495 -0.455 ...
##  $ v: num [1:5, 1:5] -0.338 -0.366 -0.587 -0.512 -0.381 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 4.04e-16" 
## [2] "Component 3: Mean relative difference: 2.647e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.11.3 pkgmaker_0.18.2   registry_0.2      Rcpp_0.10.5      
[5] knitr_1.5        
