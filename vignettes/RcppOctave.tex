...
\bibliography{/tmp/Rpkglib_4ab23b18a8c3/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.14.1
[March 10, 2014]\footnote{This vignette was built using \octave
3.8.0}}
...
\end{alltt}
\begin{verbatim}
## [1] 0.78450 0.05599 0.75929 0.16115
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.3051 0.0535 0.4899 0.9825
## 
## $b
##        [,1]   [,2]     [,3]
## [1,] 0.4039 0.7347 0.822640
## [2,] 0.3700 0.2118 0.005014
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.5398 1.0167 0.6231 0.3324 0.0574
##  $ u: num [1:5, 1:5] -0.244 -0.31 -0.482 -0.546 -0.561 ...
##  $ v: num [1:5, 1:5] -0.584 -0.432 -0.34 -0.461 -0.38 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 4.656e-16"
## [2] "Component 3: Mean relative difference: 3.531e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.14.1 pkgmaker_0.20     registry_0.2      Rcpp_0.11.0      
[5] knitr_1.5        
