...
\bibliography{/tmp/Rpkglib_3141761394f6/RcppOctave/REFERENCES}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.55347 1.18633 0.72513 0.64495 0.00172
##  $ u: num [1:5, 1:5] -0.473 -0.426 -0.501 -0.368 -0.456 ...
##  $ v: num [1:5, 1:5] -0.414 -0.542 -0.353 -0.523 -0.369 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 3.344e-16"
## [2] "Component 3: Mean relative difference: 2.779e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.13.1 pkgmaker_0.18.2   registry_0.2      Rcpp_0.10.6      
[5] knitr_1.5        
