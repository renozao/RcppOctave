...
\bibliography{/tmp/Rpkglib_1fee7c5ee746/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.13.5
[November 26, 2013]\footnote{This vignette was built using \octave
3.6.4}}
...
\end{alltt}
\begin{verbatim}
## [1] 0.123523 0.008018 0.821070 0.587862
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.9111 0.3504 0.6246 0.6998
## 
## $b
##         [,1]   [,2]    [,3]
## [1,] 0.09894 0.8589 0.07056
## [2,] 0.39388 0.2398 0.05277
## 
## $c
## [1] "some text"
\end{verbatim}
...
\hlkwd{geterrormessage}\hlstd{()}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: could not find function "{}geterrormessage"{}}}\begin{alltt}
\hlcom{# warning}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.17 0.841 0.634 0.394 0.056
##  $ u: num [1:5, 1:5] -0.271 -0.443 -0.484 -0.374 -0.597 ...
##  $ v: num [1:5, 1:5] -0.324 -0.429 -0.322 -0.385 -0.677 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 3.113e-16"
## [2] "Component 3: Mean relative difference: 3.315e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.13.5 pkgmaker_0.19.1   registry_0.2      Rcpp_0.10.6      
[5] knitr_1.5        
